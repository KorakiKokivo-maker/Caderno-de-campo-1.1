        ...
        <header className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-4">
                <img 
                    ...
                    alt="Foto do Perfil" 
                    className="w-16 h-16 rounded-full object-cover border-2 border-epagri-red"
                />
                <div>
            ...
            <button onClick={onLogout} className="flex items-center gap-2 text-epagri-red p-2 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/20 transition-colors">
